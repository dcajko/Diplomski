...
{   
	...
	{
		debugText = GetNode<RichTextLabel>("Debug");
	}
	...
	public override void _Input(InputEvent _event)
	{
		...
		if (mouseMotionEvent != null)
		{
			...
			if (debugText is RichTextLabel)
			{
				string actualString = $"{mouseMotionEvent.Position.X}; {mouseMotionEvent.Position.Y}\n" +
					 $"{mouseMotionEvent.Position.X - oldPosition.X}; {mouseMotionEvent.Position.Y - oldPosition.Y}\n";

				oldPosition.X = mouseMotionEvent.Position.X;
				oldPosition.Y = mouseMotionEvent.Position.Y;

				(debugText as RichTextLabel).Text = actualString;
			}
